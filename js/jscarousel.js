    ...
    $.fn.extend({
        ...
        jsCarousel: function(options) {
            ...
            var settings = $.extend({
                ...
                itemstodisplay: 6,/*单页图片数量*/

                autoscroll: false,

                onthumbnailclick: null /*缩略图*/
            ...
            var slidercontents = $(this).addClass('jscarousal-contents');
                ...
                var total = $('> div', slidercontents).css('display', 'none').length;/*16*/
               ...
               // console.log(total);
                ...
                function initialize() {
                    ...
                    noOfBlocks = parseInt(total / display);//块的数量
